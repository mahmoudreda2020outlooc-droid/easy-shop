            ...
            <div className="w-full max-w-[1400px] relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-4">
                            <Link
                                href="https://www.facebook.com/profile.php?id=61579511783579&locale=ar_AR"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group flex items-center gap-4 text-white/60 hover:text-[#1877F2] transition-all relative z-20"
                            >
                                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[#1877F2]/20 transition-all pointer-events-none">
